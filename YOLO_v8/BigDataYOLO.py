    ...
    for j in l2:
        for k in l3:
            for m in l4:
                ...
                save_path = "inference/images/resized.jpg"
                cv.imwrite(save_path, rescaled_image)  # save the image to print it later
                ...
                for r in detection_output:
                    ...
                    for box in boxes:
                        ...
                        if name == 15:
                            if i == "c":
                                data_2_file = i + "_" + j + "_" + str(k) + "_" + str(m) + " cat " + str(conf) + "\n"
                        ...
                        if name == 16:
                            if i == "d":
                                data_2_file = i + "_" + j + "_" + str(k) + "_" + str(m) + " dog " + str(conf) + "\n"
                                with open("p_data.txt", "a") as file:
                                    file.write(data_2_file)
